...
const DATA_DIR = process.env.DATA_DIR || path.join(os.homedir(), '.cc-studio');
...
switch (cmd) {
  ...
  default:
    console.log(`CC Studio Server Admin CLI
...
Environment:
  DATA_DIR  Database location (default: ~/.cc-studio)`);
}
