...
; ─── Product info ────────────────────────────────────────────────────
!define PRODUCT_NAME "CodexStudio"
!define PRODUCT_PUBLISHER "k0ngk0ng"
!define PRODUCT_WEB_SITE "https://github.com/k0ngk0ng/codex-studio"
!define PRODUCT_EXE "codex-studio.exe"
!define PRODUCT_UNINST_KEY "Software\Microsoft\Windows\CurrentVersion\Uninstall\${PRODUCT_NAME}"
!define PRODUCT_DIR_KEY "Software\${PRODUCT_NAME}"

; ─── Installer attributes ────────────────────────────────────────────
Name "${PRODUCT_NAME} ${PRODUCT_VERSION}"
OutFile "CodexStudio-${PRODUCT_VERSION}-Setup.exe"
