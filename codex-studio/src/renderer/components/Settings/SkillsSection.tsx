        ...
        {skills.length === 0 && !isAdding && (
          <div className="text-center py-8 border border-dashed border-border rounded-lg">
            ...
            <p className="text-xs text-text-muted mt-1">
              Add a skill to extend Codex CLI's capabilities
            </p>
          </div>
        )}
        ...
        <div className="border border-border rounded-lg p-4 bg-surface space-y-3">
          ...
          <div>
            ...
            <div className="text-xs text-text-muted mt-0.5">
              Will create <code className="bg-surface px-1 rounded">~/.codex/skills/{newName || 'name'}/SKILL.md</code>
            </div>
          </div>
