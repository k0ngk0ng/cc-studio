...
export const BUILTIN_COMMANDS: SlashItem[] = [
  ...
  { name: 'bug', description: 'Report bugs — requires terminal (codex /bug)', argumentHint: '[description]', source: 'builtin' },
  ...
  { name: 'doctor', description: 'Check installation health — requires terminal (codex /doctor)', argumentHint: '', source: 'builtin' },
  { name: 'help', description: 'Show available commands and usage information', argumentHint: '', source: 'builtin' },
  { name: 'init', description: 'Initialize CLAUDE.md — requires terminal (codex /init)', argumentHint: '', source: 'builtin' },
  { name: 'login', description: 'Switch accounts — requires terminal (codex /login)', argumentHint: '', source: 'builtin' },
  { name: 'logout', description: 'Sign out — requires terminal (codex /logout)', argumentHint: '', source: 'builtin' },
  ...
  { name: 'vim', description: 'Vim mode — requires terminal (codex /vim)', argumentHint: '', source: 'builtin' },
];
