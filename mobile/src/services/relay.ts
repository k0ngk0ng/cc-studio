...
const DEVICE_ID_KEY = 'cc-studio-device-id';
const RELAY_CONFIG_KEY = 'cc-studio-relay-config';
const E2EE_SESSIONS_KEY = 'cc-studio-e2ee-sessions';
const DEVICE_NAME = 'CC Studio Mobile';
